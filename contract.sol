...
contract sec is ERC20, Ownable {
    ...
    constructor() ERC20("Ticker SEC", "SEC") {
        ...
        maxTransactionAmount = (totalSupply) / 50; // 2% of total supply (2,000,000,000 tokens)
        maxWallet = (totalSupply) / 20;  // 5% of total supply (5,000,000,000 tokens)
    ...
    /**
     * @dev P.S.
     * This is a presale token
     * "Help me rug the SEC" - Drew Pirate Roberts AKA Swamp Cowboy
     */
}
